...
<head> 
	...
	<link rel="stylesheet"
        ...
        <script>
            function deleteSection(id_user) {
            // Make an AJAX request to the server
            var xhr = new XMLHttpRequest();
            xhr.open('POST','deleteSection.php');
            ...
            xhr.send('id_section=' + encodeURIComponent(id_user));
				...
				<div class="nav-upper-options"> 
					...
					<div class="option2 nav-option"> 
                        ...
                        "assets/logo/logo1.png"
							class="nav-img"
							alt="articles"> 
							<h3> <a style="text-decoration:none;color:#1A6C82;"  href="section.php"> saction</h3> 
					</div>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210180758/Untitled-design-(28).png"
			...
			<div class="report-container"> 
				<div class="report-header"> 
					...
					<h1 class="recent-Articles">Section</h1> 
                ...
                <?php            
                 ...
                 while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button class='delete' onclick='deleteSection(\"".$row['section_id']."\")' value='delete'>drop</button></td>";

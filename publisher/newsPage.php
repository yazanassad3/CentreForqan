...
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&family=Rakkas&display=swap" rel="stylesheet">
    ...
    <script>
        ...
        function deleteNews(id_Act) {
            // Make an AJAX request to the server
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'classNews.php');
            ...
            xhr.send('id_new=' + encodeURIComponent(id_Act));
        }
        function submitForm() {
...
<body>
    <div class="bodys">
        <div class="taskBar">
            ...
            <button class="header_button_logout" onclick="back();">عودة</button>
    ...
    <section id="reviews" class="reviews">
        <div class="section-header">
            <div class="h2 rakkas-regular">اخر الأخبار</div>
        </div><!--/.section-header-->
    ...
    <button class="open-button" onclick="openForm()">اضافة خبر جديد</button>
            ...
            <p class="text-dark-50 mb-5">Please enter your login and password!</p>-->
                    ...
                    <form id="myforms">
                        <div data-mdb-input-init class="form-outline form-dark mb-2">
                            ...
                            <input type="text" name="description" require id="typeEmailX"
                        ...
                        <div data-mdb-input-init class="form-outline form-dark mb-2">
                            <label class="form-label" for="typePasswordX">عنوان الخبر</label>
